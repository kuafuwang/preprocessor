...
public class Definitions
{
 ...
 public   boolean has_build_properties = false;
  ...
  public Map<String, String> getAllDefines(){
    Map<String, String> _all_defines= new HashMap<>();

    _all_defines.putAll(_localDefs);
    _all_defines.putAll(_localUnDefs);
    Definitions parent = _parent.get();
    if(null != parent){
      _all_defines.putAll(parent.getAllDefines());
    }
    return _all_defines;
  }
